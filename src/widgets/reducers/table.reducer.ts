import { IUserData } from "../../entities/index.ts"
import { SortEnum } from "../../features/index.ts"
import { INITIAL_STATE } from ".."
import { TableReducerState, TableActions } from ".."
    ...
    switch(action.type) {
        case SortEnum.Init:
            return {
                ...
                userData: action.payload.toSorted((a: IUserData, b: IUserData) => a.id > b.id ? 1 : -1),
                countPages: state.countPages
            }
        case SortEnum.DescId:
            return {
                sort: {...INITIAL_STATE.sort, id: 'asc'},
                userData: state.userData.toSorted((a: IUserData, b: IUserData) => a.id > b.id ? 1 : -1),
                countPages: state.countPages
            }
        case SortEnum.AscId:
            return {
        ...
        case SortEnum.DescFirstName:
            return {
                ...
                userData: state.userData.toSorted((a: IUserData, b: IUserData) => a.firstName > b.firstName ? 1 : -1),
                countPages: state.countPages
            }
        ...
        case SortEnum.DescLastName:
            return {
                ...
                userData: state.userData.toSorted((a: IUserData, b: IUserData) => a.lastName > b.lastName ? 1 : -1),
                countPages: state.countPages
            }
